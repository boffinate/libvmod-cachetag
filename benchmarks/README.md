...
- `BENCH_STORAGE_KIND`: `default` for the normal benchmark storage path, `fellow` for a patched Slash/Fellow storage lane, or `buddy` for an unpatched Slash/Buddy storage lane.
